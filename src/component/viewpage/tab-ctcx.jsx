...
export default function ScrollableTabsButtonVisible() {
    ...
    return (
        ...
        >
            ...
            <TabPanel value={value} index={2}>
                ...
                <div className="button-binh-luan">
                    <div>
                        ...
                        <button>5<StarIcon sx={{ fontSize: 20 }} /> (29)</button>
                        <button>4<StarIcon sx={{ fontSize: 20 }} /> (29)</button>
                        <button>3<StarIcon sx={{ fontSize: 20 }} /> (29)</button>
                        <button>2<StarIcon sx={{ fontSize: 20 }} /> (29)</button>
                        <button>1<StarIcon sx={{ fontSize: 20 }} />(29)</button>
                    </div>
                </div>
                <div className="binh-luan">
                    <div className="item-bl">
                        ...
                        <div className="tgian-bl">
                            <p>Đi ngày 24/06/2024 <span><VerifiedIcon sx={{ width: '16px' }} /> Đã đặt vé</span></p>
                        </div>
                    </div>
                    <div className="item-bl">
                        <div className="item-bl-infouse">
                ...
                <Pagination count={10} variant="outlined" color="primary" sx={{ display: 'flex', justifyContent: 'center' }} />
            </TabPanel>
                ...
                <div className="chinh-sach-container">
                    <div className="cs-top">
                        ...
                        <div className='hinh-anh-truc-quan'>
                            <div className='thoi-gian-hm'><strong>18:01</strong> <p>08/09/2024</p></div>
                            <div>
                                ...
                                <div className="thanh-mua-do">
                                    ...
                                    <CircleIcon sx={{ fontSize: 14, color: 'white', margin: 'auto', marginLeft: '230px' }} />
                                </div>
                            </div>
                    ...
                    <div className="note">
                        <strong>Ghi chú:</strong><span> Phí huỷ sẽ được tính trên giá gốc, không giảm trừ khuyến mãi hoặc giảm giá; đồng thời không vượt quá số tiền quý khách đã thanh toán.</span>
                    </div>

                    <div className="chinh-sach-nha-xe">
                        <p>Chính sách nhà xe</p>
                        <ul> Yêu cầu khi lên xe
                        ...
                        <ul>
                            ...
                            <li>Trẻ em dưới 3 tuổi hoặc dưới 100 cm được miễn phí vé nếu ngồi cùng ghế/giường với bố mẹ</li>
                        ...
                        <ul>Động vật cảnh/Thú cưng
                            <li>Nhà xe không nhận chở động vật cảnh/thú cưng</li>
                        </ul>
                        <ul>Xuất hóa đơn GTGT
                            <li>Nhà xe có cung cấp hóa đơn GTGT cho dịch vụ xe khách, phí xuất hóa đơn là 10 % trên giá dịch vụ quý khách đã mua</li>
            ...
            <CancelIcon sx={{ position: 'absolute', top: 0, right: 0, color: 'red' }} onClick={openttct} />
            <Drawer anchor="right" open={drawer} variant="temporary" onClose={() => setDrawer(false)} PaperProps={{
        sx: { width: '42%' }, // Điều chỉnh chiều rộng ở đây
                ...
                <div className="chi-tiet-ma-giam-gia">
                    ...
                    <div className="ctmgg-nd">
                        ...
                        <div className="phan-tram-giam">
                           Giảm 10%
                        </div>
                        <div className="dieu-kien-giam1">
                            Đơn hàng tối đa 1 vé
                        </div>
                        <div className="tg-giam">
                        <QueryBuilderIcon sx={{color:'#2474E5'}}/>
                        <p><strong>HSD:</strong><span> T3, 09/09/2024</span></p>
                        </div>
                    </div>
                    ...
                    <h3>Phạm vi áp dụng</h3>
                        <div className="pv pv-1">
                          ...
                          <div><strong>Tuyến đường:</strong>Tất cả tuyến đường</div>
                        </div>
                        <div className="pv pv-2">
                          <DirectionsBusFilledIcon sx={{color:'#2474E5'}}/>
                          <div><strong>Nhà xe:</strong>Áp dụng cho tất cả nhà xe</div>
                        </div>
                        <div className="pv pv-3">
                          <AccessTimeIcon sx={{color:'#2474E5'}}/>
                         
                          <div><strong>Ngày đặt vé:</strong> T3, 10/09 12:00 - T3, 10/09 14:00</div>
                        </div>
                        <div className="pv pv-4">
                          <CalendarTodayIcon sx={{color:'#2474E5'}}/>
                          <div><strong> Ngày khởi hành:</strong> T3, 10/09 12:00 - T2, 23/09 14:00</div>
                        </div>
                    </div>
                    <div className="dk-su-dung">
                        <h3>Diều kiện sử dụng</h3>
                        <p>Giảm 10% khi đơn hàng có tối đa 1 vé</p>
                        <p>- Lưu ý: Đối với vé khứ hồi, giá trị đơn hàng và số lượng vé được xét giảm giá trên từng chiều</p>
                        ...
                        <p>- Ưu đãi chỉ áp dụng cho KH đặt vé tại Website/App và tổng đài đặt vé VeXeRe. Không áp dụng hình thức thanh toán tại Nhà xe.</p>
