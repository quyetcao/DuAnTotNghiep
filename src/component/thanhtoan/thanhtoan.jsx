                                ...
                                <div className="group-payment">
                                    ...
                                    <div className="payment-item border-bottom">
                                        ...
                                        <div className="ant-collapse-content-box">
                                            <div className="COP__Container-sc-1r3r2bs-0 hdMCHW">
                                                <p className="base__Headline02-sc-1tvbuqk-11 dwyAVK color--darkness">Hướng dẫn thanh toán</p>
                                                <div className="cop-content color--darkness">
                                                    <div className="cop-text"><p>Bạn hãy nói rằng đã đặt chỗ qua Vexere và thanh toán <strong>130.000đ</strong> cho tài xế khi lên xe.</p>
                                                    </div>
                                                </div>
                                                <div className="cop-notice">
                                                    <p className="base__Headline03-sc-1tvbuqk-15 boemqK color--darkness">Lưu ý quan trọng</p>
                                                    <div className="TrustMessage__Container-sc-8xur6b-0 fzgXBM trust-message-content-container trust-message-container warning undefined">
                                                        <div className="material-icons-wrapper md-16 info-note-icon ">
                                                            <WarningIcon sx={{color:'#FFAF1F'}}/>
                                                        </div>
                                                        <p className="base__Body02-sc-1tvbuqk-23 gymsWw trust-message-content color--darkness">Hãy hủy vé khi không còn nhu cầu di chuyển. Vexere sẽ yêu cầu bạn thanh toán trước cho những lần sau nếu bạn đặt vé nhưng không đi hoặc huỷ vé quá nhiều lần.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="payment-item border-bottom">
                                        ...
                                        <div className="ant-collapse-content-box">
                                            <span className="PaymentMethods__LabelStyle-sc-6pvdqp-2 PaymentMethods__PaymentGuide-sc-6pvdqp-3 hUFPSU iIqzBs">Hướng dẫn thanh toán</span>
                                            <div className="PaymentMethods__GuildContainer-sc-6pvdqp-5 jCaFku">
                                                <p>1. Bạn sẽ được chuyển đến ứng dụng ShopeePay<br />
                                                    2. Nhập thông tin thẻ thanh toán mới hoặc chọn thanh toán qua ví ShopeePay/thẻ đã liên kết với ví ShopeePay<br />
                                                    3. Chọn "Thanh toán" để tiến thành thanh toán vé</p>
                                            </div></div>
                                    </div>
                                    <div className="payment-item border-bottom">
                                        <lable className="list-qr">
                                        ...
                                        <div className="ant-collapse-content-box">
                                            <span className="PaymentMethods__LabelStyle-sc-6pvdqp-2 PaymentMethods__PaymentGuide-sc-6pvdqp-3 hUFPSU iIqzBs">Hướng dẫn thanh toán</span>
                                            <div className="PaymentMethods__GuildContainer-sc-6pvdqp-5 jCaFku">
                                                <p>1. Đăng nhập Ứng dụng ngân hàng hoặc Ví VNPAY<br />
                                                    2. Quét mã VNPAY-QR để thanh toán<br />
                                                    3. Nhập số tiền thanh toán &amp; mã giảm giá (nếu có), xác minh giao dịch để đặt vé </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="payment-item border-bottom">
                                        ...
                                        <div className="ant-collapse-content ant-collapse-content-active" >
                                            <div className="ant-collapse-content-box">
                                                <span className="PaymentMethods__LabelStyle-sc-6pvdqp-2 PaymentMethods__PaymentGuide-sc-6pvdqp-3 hUFPSU iIqzBs">Hướng dẫn thanh toán</span>
                                                <div className="PaymentMethods__GuildContainer-sc-6pvdqp-5 jCaFku">
                                                    <p>1. Bạn sẽ được chuyển đến ứng dụng Momo<br />
                                                        2. Nhập thông tin thẻ thanh toán mới hoặc chọn thanh toán qua ví Momo/thẻ đã liên kết với ví Momo<br />
                                                        3. Chọn "Thanh toán" để tiến thành thanh toán vé</p>
                                                </div></div></div>
                                    </div>
                                    <div className="payment-item border-bottom">
                                    ...
                                    <div className="payment-item border-bottom">
                                        ...
                                        <div className="ant-collapse-content-box">
                                            <span className="PaymentMethods__LabelStyle-sc-6pvdqp-2 PaymentMethods__PaymentGuide-sc-6pvdqp-3 hUFPSU iIqzBs">Hướng dẫn thanh toán</span>
                                            <div className="PaymentMethods__GuildContainer-sc-6pvdqp-5 jCaFku">
                                                <p>1. Bạn sẽ được chuyển đến ứng dụng Viettel Money</p>
                                                <p>2. Bạn có thể&nbsp;đăng nhập vào tài khoản Viettel Money hoặc mở ứng dụng Viettel Money để quét mã QR thanh toán</p>
                                            </div></div>
                                    </div>
                                    ...
                                    <div className="coupon-info-route-page-container">
                                        <div className="giamgia">
                                            ...
                                            <div className='thong-tin-ve-giam'>
                                                <div className='title-giam-gia'>Bạn Mới (Vexere) <ErrorIcon /></div>
                                                <div className="price-giam">Giảm 10%</div>
                                                <div className="dk-giam">Đơn hàng tối đa 1 vé</div>
                                                <div className="hsd">HSD:<strong>T3, 10/9 14:00</strong></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="coupon-info-route-page-container">
                                ...
                                <div className="cart-tt-detail">
                                    <div className="section-ticket-header pointer">
                                        <div className="section-ticket-header-left">
                                            <img className="bus-blue-icon ls-is-cached lazyloaded" data-src="https://229a2c9fe669f7b.cmccloud.com.vn/svgIcon/bus_blue_24dp.svg" src="https://229a2c9fe669f7b.cmccloud.com.vn/svgIcon/bus_blue_24dp.svg" alt="bus_blue_icon" width="16" height="16" />
                                            <p className="base__Caption01Highlight-sc-1tvbuqk-17 jCbuWT">T6, 13/09/2024</p>
                                            <div className="total-ticket">
                                                <img className="people-icon ls-is-cached lazyloaded" data-src="https://229a2c9fe669f7b.cmccloud.com.vn/svgIcon/people_alt_black_24dp.svg" src="https://229a2c9fe669f7b.cmccloud.com.vn/svgIcon/people_alt_black_24dp.svg" alt="people_alt_black_icon" width="16" height="16" />
                                                <p className="base__Caption01-sc-1tvbuqk-16 jPSIDj">1</p>
                                            </div>
                                        </div>
                                        <div>
                                            <p className="base__Button02-sc-1tvbuqk-37 bVQrWf color--vex-blue text--underline">Chi tiết</p>
                                        </div>
                                    </div>
                                    <div className="section-ticket-content">
                                        <div className="section-ticket-company-info pointer">
                                            <div>
                                                <img src="https://static.vexere.com/production/images/1620363223951.jpeg" alt="avatar" className="BoxReviewInfoTicketRoundTrip__ImageStyled-as8crw-1 beAglg" />
                                            </div>
                                            <div className="section-ticket-company-info-name">
                                                <p className="base__Headline03-sc-1tvbuqk-15 boemqK">Nam Quỳnh Anh</p>
                                                <p className="base__SmallCaption-sc-1tvbuqk-32 eSKsXb">Limousine giường phòng 34 chỗ (mới)</p>
                                            </div>
                                        </div>
                                                    ...
                                                    <div className="area-point-container pointer">
                                                        <div className="date-time-container">
                                                            <div className="date-time-container-pick-up">
                                                                <div className="base__Headline01-sc-1tvbuqk-44 kxACTE">23:40</div>
                                                            </div>
                                                        </div>
                                                        <div className="icon-container">
                                                            <div className="icon-container-top">
                                                                <img className="pickup-icon ls-is-cached lazyloaded" data-src="https://229a2c9fe669f7b.cmccloud.com.vn/svgIcon/pickup_vex_blue_24dp.svg" src="https://229a2c9fe669f7b.cmccloud.com.vn/svgIcon/pickup_vex_blue_24dp.svg" alt="pickup-icon" width="12" height="12" />
                                                            </div>
                                                            <div className="icon-container-divider">
                                                                <div className="icon-container-divider-border-right">
                                                                </div>
                                                                <div className="icon-container-divider-border-left">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div className="section-area">
                                                            <div className="section-area-picker">
                                                                <p className="base__Caption01Highlight-sc-1tvbuqk-17 jCbuWT">Bến xe Nước Ngầm</p>
                                                                <p className="base__SmallCaption-sc-1tvbuqk-32 eSKsXb color--medium-sub">Số 1 Ngọc Hồi</p>
                                                            </div>
                                                            <div className="button-mobile-change">
                                                                <p className="base__Button02-sc-1tvbuqk-37 bVQrWf color--vex-blue text--underline">Thay đổi</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div className="area-point-container pointer">
                                                        <div className="date-time-container">
                                                            <div className="date-time-container-drop-off">
                                                                <div className="base__Headline01-sc-1tvbuqk-44 kxACTE">06:25</div>
                                                                <p className="base__SmallCaptionHighlight-sc-1tvbuqk-35 gzSlSc color--medium-sub">(14/09)</p>
                                                            </div>
                                                        </div>
                                                        <div className="icon-container">
                                                            <div className="icon-container-divider">
                                                                <div className="icon-container-divider-border-right">
                                                                </div><div className="icon-container-divider-border-left"></div>
                                                            </div>
                                                            <div className="icon-container-bottom">
                                                                <img className="dropoff-icon ls-is-cached lazyloaded" data-src="https://229a2c9fe669f7b.cmccloud.com.vn/svgIcon/dropoff_semantic_negative_12dp.svg" src="https://229a2c9fe669f7b.cmccloud.com.vn/svgIcon/dropoff_semantic_negative_12dp.svg" alt="dropoff-icon" width="12" height="12" />
                                                            </div>
                                                        </div>
                                                        <div className="section-area">
                                                            <div className="section-area-picker">
                                                                <p className="base__Caption01Highlight-sc-1tvbuqk-17 jCbuWT">Bến Xe Bắc Vinh</p>
                                                                <p className="base__SmallCaption-sc-1tvbuqk-32 eSKsXb color--medium-sub">xã Nghi Kim</p>
                                                            </div>
                                                            <div className="button-mobile-change">
                                                                <p className="base__Button02-sc-1tvbuqk-37 bVQrWf color--vex-blue text--underline">Thay đổi</p>
                                                            </div>
