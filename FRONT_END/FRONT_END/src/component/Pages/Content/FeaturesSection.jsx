...
const features = [
    {
        icon: '../../images/img_content/bus-car-icon.svg', // Đường dẫn tới icon
    ...
    {
        icon: '../../images/img_content/yellow-ticket-icon.svg',
        title: 'Đặt vé dễ dàng',
        description: 'Tích hợp nhiều phương thức thanh toán an toàn và thuận tiện'
    },
    {
        icon: '../../images/img_content/completement-icon.svg',
    ...
    {
        icon: '../../images/img_content/coupon-icon.svg',
        title: 'Nhiều ưu đãi',
