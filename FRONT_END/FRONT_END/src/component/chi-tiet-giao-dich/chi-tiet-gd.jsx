        ...
        <>
            <div className='thanh-thong-bao'>
                <p className='notification-heading'>
                    Vui lòng thanh toán trước <strong>14:53 • T6, 13/09</strong>. Vé sẽ bị hủy sau thời gian trên
                </p>
            </div>
                        ...
                        <div className='wrap-left'>
                            <div className='hd-thanh-toan'>
                                ...
                                <div className='cop-text'>
                                    <p>
                                        Bạn hãy nói rằng đã đặt chỗ qua Vexere và thanh toán <strong>120.000đ</strong>{' '}
                                        cho tài xế khi lên xe.
                                    </p>
                                </div>
                                <div className='luu-y'>
                                    ...
                                    <div className='TrustMessage__Container-sc-8xur6b-0 fzgXBM trust-message-content-container trust-message-container warning undefined'>
                                        ...
                                        <p className='luy-y-text'>
                                            Hãy hủy vé khi không còn nhu cầu di chuyển. Vexere sẽ yêu cầu bạn thanh toán
                                            trước cho những lần sau nếu bạn đặt vé nhưng không đi hoặc huỷ vé quá nhiều
                                            lần.
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div className='cart-thong-tin-chuyen-di'>
                                ...
                                <div className='cart-tt-detail'>
                                    ...
                                    <div className='section-ticket-content'>
                                        <div className='section-ticket-content-info pointer'>
                                            <div>
                                                <img
                                            ...
                                            <div className='section-ticket-license-plate  '>
                                                <div className='base__Caption02-sc-1tvbuqk-33 hbMYEr color--dark title-ttcx-bsx'>
                                                    Biển số xe
                                                </div>
                                                <div className='section-ticket-license-plate-detail section-ticket-license-plate-detail1'>
                                                    <p className='base__Caption01Highlight-sc-1tvbuqk-17  color--darkness'>
                                                        29B-097.88
                                                    </p>
                                                </div>
                                            </div>
                                        ...
                                        <div className='BoxReviewInfoTicketRoundTrip__BoxTicketRouteDetailContainer-as8crw-2 evVLoJ'>
                                            ...
                                            <div className='section-ticket-confirm status--success'>
                                                <div className='section-ticket-confirm-left'>
                                                    <img
                                                        className='IconComponent__SVGIcon-r88lg2-0 jtexIT'
                                                        src='https://229a2c9fe669f7b.cmccloud.com.vn/svgIcon/confirmed.svg'
                                                        alt='confirmed'
                                                    />
                                                    <p className='base__Caption01-sc-1tvbuqk-16 jPSIDj color--dark'>
                                                        Nhà xe đã xác nhận vé
                                                    </p>
                                                </div>
                                                <div className='section-ticket-confirm-right'>
                                                    <p className='base__Caption01-sc-1tvbuqk-16 jPSIDj color--dark text-code'>
                                                        Mã đặt chỗ: 5K4SB5H
                                                    </p>
                                                </div>
                                            </div>
                        ...
                        <div className='wrap-right'>
                            ...
                            <div className='cart-khuyen-mai'>
                                ...
                                <div className='content-container'>
                                    <a
                                        href='https://vexere.com/vn/thue-xe/xe-may.vi'
                                        className='container-rental container-rental1'
                                    >
                                        <img
                                            className='container-img-background ls-is-cached lazyloaded'
                                            data-src='https://229a2c9fe669f7b.cmccloud.com.vn/images/mobile-card1.png'
                                            src='https://229a2c9fe669f7b.cmccloud.com.vn/images/mobile-card1.png'
                                            alt='motobike-rental'
                                            height='64'
                                        />
                                        <div className='RecommendSection__Card-sc-7ggvh9-1 jwCKCw'>
                                            <div className='header-container'>
                                                <div className='header-title'>
                                                    Thuê xe máy đời mới, giao tận khách sạn
                                                </div>
                                                <div className='header-content'>Đà Lạt, Vũng Tàu, Sa Pa, Hà Giang</div>
                                                <img
                                                    className='image-motobiker ls-is-cached lazyloaded'
                                                    data-src='https://229a2c9fe669f7b.cmccloud.com.vn/images/motobiker-rental.png'
                                                    src='https://229a2c9fe669f7b.cmccloud.com.vn/images/motobiker-rental.png'
                                                    alt='motobike-rental'
                                                    width='167'
                                                    height='120'
                                                />
                                    ...
                                    <a
                                        href='https://vexere.com/dich-vu/thue-xe-du-lich/'
                                        className='container-rental container-rentail-2'
                                    >
                                        <img
                                            className='container-img-background ls-is-cached lazyloaded'
                                            data-src='https://229a2c9fe669f7b.cmccloud.com.vn/images/mobile-card2.png'
                                            src='https://229a2c9fe669f7b.cmccloud.com.vn/images/mobile-card2.png'
                                            alt='bus-rental'
                                            height='64'
                                        />
                                        <div className='RecommendSection__Card-sc-7ggvh9-1 jwCKCw'>
                                            <div className='footer-container-rental'>
                                                <img
                                                    className='image-bus ls-is-cached lazyloaded'
                                                    data-src='https://229a2c9fe669f7b.cmccloud.com.vn/images/bus-hide.png'
                                                    src='https://229a2c9fe669f7b.cmccloud.com.vn/images/bus-hide.png'
                                                    alt='bus-hide'
                                                    width='128'
                                                    height='83'
                                                />
