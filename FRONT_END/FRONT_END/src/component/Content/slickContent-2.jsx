    ...
    return (
        <Slider {...settings}>
            ...
            <div className='scroll-list-item-udnb' style={{ width: 300, height: 250 }}>
                ...
                />
                <div className='item-content'>
                    <div className='item-content-title'>Giới thiệu bạn mới - Nhận quà khủng từ Vexere</div>
                </div>
            </div>
            ...
            <div className='scroll-list-item-udnb' style={{ width: 300, height: 250 }}>
                ...
                />
                <div className='item-content'>
                    <div className='item-content-title'>Đặt xe khách tại Vexere - Thuê thêm xe máy giảm đến 20%</div>
                </div>
            </div>
            ...
            <div className='scroll-list-item-udnb' style={{ width: 300, height: 250 }}>
                ...
                />
                <div className='item-content'>
                    <div className='item-content-title'>Nhận ưu đãi x2 khi đặt dịch vụ xe khách khứ hồi</div>
                </div>
            </div>
            ...
            <div className='scroll-list-item-udnb' style={{ width: 300, height: 250 }}>
                ...
                />
                <div className='item-content'>
                    <div className='item-content-title'>Tổng hợp chương trình khuyến mãi trong tháng</div>
                </div>
            </div>
